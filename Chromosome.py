...
class Chromosome:
    ...
    def __init__(self):
        # jako lista genów (gen jako pozycja? zestaw genów jako trasa pozycji do celu?)
        self.genes = []
        # ocena skuteczności (na podstawie odległości od pola końcowego i zebranych monet?)
        self.rating = 0.0
